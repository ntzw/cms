...
namespace DataAccess.MySql.CMS
{
    public class ContentDapper : IContentDapper
    {
        ...
        {
            var whereSql = PageSqlHelper().OutDefaultParams(req.Queries, out var whereParams);
            var dataSql = PageSqlHelper().GetPageDataSql(req, whereSql, tableName);
            var countSql = PageSqlHelper().GetPageCountSql(whereSql, tableName);
        ...
        {
            var whereSql = PageSqlHelper().OutDefaultParams(request.Queries, out var whereParams);
