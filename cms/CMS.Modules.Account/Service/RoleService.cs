...
{
    public class RoleService : DefaultService<Role, IRoleDapper>, IRoleService
    {
        private readonly IRoleDapper _dapper;
        protected override IRoleDapper GetDapper() => _dapper;

        public RoleService(IRoleDapper dapper)
        {
            _dapper = dapper;
        }
